...
RULES = """Whyline relay plan format
...
- For phases that need a review point, use one plan file per phase and start each phase with `whyline-relay start --plan PATH`."""
